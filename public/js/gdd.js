...
const TECHMAP = {
  ...
  // ⚠️ ICL-таблица выноса NPK по факту сбора (200 фунтов N/акр на 20 т/акр ≈ 4.5–5.0 кг N/т) даёт
  ...
  // таблица выноса даёт 200 фунтов N/акр, а помесячная таблица динамики на той же странице — 89),
