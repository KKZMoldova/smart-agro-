...
const TECHMAP = {
  ...
  crop_apple: [
    ...
    { phase:'Завязь', bbch:'BBCH 71–75 (Petal Fall)', period:'Конец апреля – май', kc:0.75, film:'Открытый сад', irrigation:'15–20 мм/неделю', nutrition:'Ca(NO₃)₂ через капельницу или некорневая CaCl₂ 0.3% каждые 7–10 дней — старт основной программы против bitter pit (≈4.5–16 кг Ca/га за сезон, Rutgers 10.3; ~10 кг Ca/га/год — ориентир BC Tree Fruit Guide, укладывается в диапазон). 📌 Первые 6–8 недель после цветения — окно максимального накопления Ca в плодах (ERSA FVG), именно на это окно должна приходиться самая частая некорневая программа. ⚠️ CaCl₂ НЕ смешивать в баке с каптаном, карбарилом (Sevin XLR — см. прореживание ниже), тиофанат-метилом (Топсин), препаратами Mg или Zn — несовместимы (BC Tree Fruit Guide); не обрабатывать при T>27°C — риск ожога листа. Не злоупотреблять K в этот период — избыток K подавляет усвоение Ca и Mg',
      protection:['Плодожорка яблонная — первая обработка через 2–3 недели после лепестков по DD-модели (250 DD база 10°C от биофикса)','Долгоносик-казарка (Plum Curculio) — критическое окно с лепестков до 2-го опрыскивания','Фунгицид против парши продолжается при влажной погоде, добавить защиту от мучнистой росы','Плодовый пилильщик (Hoplocampa testudinea) — порог обработки 20–30 взрослых особей/ловушку/неделю (ERSA FVG), обработка сразу после массового опадения лепестков при превышении порога'],
      ...
      regulators:['Химическое прореживание (7–25 дней после полного цветения): NAA/NAD (Fruitone L/N) при завязи 8–10мм и T≥10°C, лучше в пасмурную влажную погоду — ⚠️ ФИТОТОКСИЧЕН на Red Delicious И Braeburn (ERSA FVG: "fitotossico su Red Delicious e Braeburn"; BC Guide отдельно предупреждает про Red Delicious — риск карликовых "pygmy" плодов); на молодых деревьях Gala и Granny Smith, а также на слабозавязывающихся насаждениях Granny Smith — не применять (ERSA FVG)','Sevin XLR (карбарил) 10–25 дней после цветения при завязи 10–15мм и тёплой солнечной погоде (T≥20°C ближайшие 5 дней) — не более 1 обработки/сезон, вредит хищным клещам','MaxCel/Cilis Plus (6-BA) от опадения лепестков (6мм) до 10мм — усиливает эффект карбарила и размер плода; та же осторожность с Red Delicious при смеси с NAA','Metamitron (Brevis) от опадения лепестков до 16-18мм — предпочтителен на Gala и Red Delicious spur (ERSA FVG)','Accede (ACC) при 15–20мм — вспомогательный инструмент, если основное прореживание недостаточно, не замена основной программе','Apogee (пропогексадион-Ca) — регулятор вегетативного роста + подавление ВТОРИЧНОГО бактериального ожога (побеговая форма, не цветковая): первая обработка при 5см прироста побега, далее каждые 14–21 дней, максимум 4 обработки/сезон; второе внесение через 12–15 дней на сильнорослых деревьях, обрабатывать верхнюю половину кроны при T>15°C и высокой влажности; ⚠️ НЕ смешивать с листовыми удобрениями и фосфитом калия, выдерживать интервал 2–3 дня от этефона/NAD/гиббереллинов (ERSA FVG)'],
    ...
    { phase:'Рост плода', bbch:'BBCH 75–79 (First–Late Covers)', period:'Июнь – начало августа', kc:1.0, film:'Открытый сад', irrigation:'20–30 мм/неделю в жару, пульсирующий полив 2–3 цикла/день на лёгких почвах', nutrition:'K (сульфат калия) 8–12 кг/га на налив + продолжение Ca-программы (хелат каждые 7–10 дней). N по остаточной потребности, не форсировать. Mg — только при подтверждённом дефиците: некорневая в июне, при необходимости повторить в июле; ⛔ НЕ применять после 1 августа (WSU Crop Protection Guide). Наш подход — "Mg только по дефициту" (WSU), а не ежегодная профилактика MgSO₄ при опадении лепестков, как предлагает BC Tree Fruit Guide — сохраняем WSU-логику, т.к. она завязана на наши листовые нормы. ⚠️ Избыток K подавляет усвоение Ca и Mg — не превышать дозу сульфата калия (BC Tree Fruit Guide)',
      protection:['Плодожорка яблонная — 2-е и 3-е поколение по DD-модели (1250 и 2300 DD от биофикса), чередовать группы д.в. против резистентности','Яблонная плодовая муха (Apple Maggot) — с конца июня/июля, порог 2–5 мух/жёлтую ловушку/неделю','Мучнистая роса, сажистый налёт и мухосед (Sooty Blotch/Flyspeck) — покровные фунгициды в влажную погоду','Растительноядные клопы (стинк-баги) и цикадки — по порогу на листовых учётах','⚠️ После града — фунгицидная обработка (дитианон или аналог) в течение 24ч для заживления ран на плодах и побегах, снижает инфекцию через повреждения (ERSA FVG)'],
    ...
    { phase:'Созревание', bbch:'BBCH 81–89', period:'Август – сентябрь (по сорту)', kc:0.9, film:'Открытый сад', irrigation:'15–20 мм/неделю, избыток воды снижает Brix и лёжкость', nutrition:'⛔ Стоп N за 4–6 недель до сбора. Соотношение K/N важнее абсолютного количества N и должно быть максимально высоким в последние 1.5–2 месяца перед сбором (ICL Growing Solutions) — избыток N при низком K повышает риск горькой ямчатости так же, как и дефицит Ca. Ca-обработки продолжать до последней недели — главная защита от горькой ямчатости в хранении',
      ...
      regulators:['ReTain (AVG) — стоп-дроп за 4 недели до ожидаемого сбора: задерживает предуборочное опадение на ~10 дней, замедляет размягчение и распад крахмала, снижает загар при хранении в РА; на Gala дополнительно снижает растрескивание плодов; ⚠️ на Gala и Spartan в отдельные годы задерживает развитие красной окраски (BC Tree Fruit Guide) — учитывать при планировании даты сбора для рынка, где критичен цвет; НЕ смешивать с NAA/этефоном (противоположный эффект на этилен)','BLUSH (прогидроджазмон) — усиление окраски, 100–200ppm, 1–2 обработки с интервалом 7–14 дней за 7–28 дней до сбора, лучше утром/вечером в сухую погоду с длительным просыханием'],
    ...
    { phase:'После сбора', bbch:'BBCH 91–97', period:'Сентябрь – октябрь', kc:0.6, film:'Открытый сад', irrigation:'Снижать постепенно до конца октября, затем прекратить',
      ...
      protection:['Ca-ванна перед закладкой на хранение — хлорид кальция (пищевой) в дип-растворе снижает горькую ямчатость и улучшает лёжкость (Rutgers 10.3, "Dip before Storage"); для сортов с высокой восприимчивостью к ямчатости и загару (напр. Granny Smith) UC Davis даёт конкретные концентрации: 3–4% хлопья CaCl₂ (77%) ИЛИ 2–3% обычный CaCl₂ ИЛИ 0.7–1% в пересчёте на ион Ca²⁺','Мочевина 5% — ускоряет листопад и разложение листвы, снижает запас инфекции парши (Venturia inaequalis) на будущий год (WSU Tree Fruit)','Мочевина 2% + сульфат цинка 2% — ускоряет листопад и повышает морозостойкость дерева (WSU Tree Fruit)','Медьсодержащий препарат перед листопадом — снижает инфекционный фон парши и бактериального ожога; при подтверждённом дефиците Cu по листу (редко) этот же препарат частично закрывает и потребность в меди (1.12 кг Cu/га как CuSO₄, WSU) — риск ожога плода при обработке до полного сбора; ⚠️ Cu-препарат НЕ смешивать в баке с хлоридом кальция — несовместимы, риск повреждения плода (WSU Crop Protection Guide)'],
  ...
  // Источники: Guy Sela "Fertilization and Irrigation" 2023 (nutrientNorms N90/P2O5 40/K2O120/Ca35/Mg18
  // на 15 т/га — заложено в S.crops.crop_sour_cherry); Michigan State University Extension (canr.msu.edu) —
  // ведущий источник по Prunus cerasus (Montmorency): осенняя некорневая N, коккомикоз (Cherry Leaf Spot,
  // Blumeriella jaapii = dc2) как приоритетная угроза №1, тайминг мучнистой росы (первая покровная сразу
  // после опадения лепестков), GDD-модель Drosophila suzukii (валидирована MSU на вишне, доступна на
  // Enviroweather). Пороги вредителей (sc_fly/sc_swd/sc_aph/sc_wvl/sc_mite/sc_moth/sc_tort/sc_saw) и
  // болезней (dc1-dc7,dc11-dc19) уже откалиброваны в S.crops/diseaseCatalog (UC IPM) — здесь эти пороги
  // только цитируются, не переопределяются. LEAF_NORMS_CHERRY (irrigation.js) откалиброваны по Neilsen
  // для ЧЕРЕШНИ (crop_cherry) — для вишни используются как приближение, отдельных норм для Prunus cerasus
  // не публиковалось в проработанных источниках; расхождение отмечено явно, где это важно.
  // Открытый сад без плёночного укрытия (в отличие от crop_cherry) — поле film описывает только
  // погодные риски.
  crop_sour_cherry: [
    { phase:'Покой', bbch:'BBCH 00–01', period:'Ноябрь – Февраль', kc:0, film:'Открытый сад — укрытия нет', irrigation:'Не нужен', nutrition:'Нет',
      protection:['Побелка штамбов и скелетных ветвей (известь + CuSO₄) — защита от солнечных ожогов коры и бактериального рака (dc5)','Обрезка (декабрь–январь) — санитарная + формировочная, убрать всю мумифицированную падалицу — источник монилиоза на будущий год','Уборка и уничтожение опавших листьев — снижает инфекционный запас коккомикоза (dc2) на следующий сезон'],
      tasks:['Проверить шпалеру/опоры, отремонтировать при необходимости','Анализ почвы — план внесения извести/удобрений на сезон (нормы Sela: N90/P2O5 40/K2O120/Ca35/Mg18 на 15 т/га)','Настроить метеостанцию и феромонные ловушки к марту','Пополнить запасы препаратов на сезон'],
      alert:'🔥 Не оставлять срезанные ветки с язвами бактериального рака в саду — источник заражения весной' },
    { phase:'Набухание почек', bbch:'BBCH 01–03', period:'Начало марта', kc:0.3, film:'Открытый сад', irrigation:'Минимальный — 5–8 мм/неделю', nutrition:'Некорневая мочевина 3–5% — азотный старт при слабом N по прошлогоднему листовому анализу',
      protection:['Медьсодержащий (бордоская смесь 3% или Купроксат) — профилактика монилиоза (dc1) и клястероспориоза (dc3) по спящим почкам','Долгоносик-цветоед (sc_wvl) — порог GDD 60, встряхивание ветвей при T>12°C для учёта, обработка при обнаружении ДО распускания'],
      tasks:['Проверить феромонные ловушки и метеостанцию','Финальная обрезка если не сделана зимой','Первая калибровка датчиков влажности почвы после зимы'],
      alert:'❄️ Почки уязвимы к заморозкам — контролировать ночные минимумы' },
    { phase:'Распускание почек', bbch:'BBCH 07–09', period:'Середина марта', kc:0.4, film:'Открытый сад', irrigation:'8–10 мм/неделю', nutrition:'N-старт: аммиачная селитра или КАС по норме почвенного анализа',
      protection:['Продолжение медьсодержащей программы против монилиоза и клястероспориоза по мере разворачивания листьев','Мучнистая роса (dc4) — риск начинается уже на этой стадии в тёплую сухую погоду'],
      tasks:['Проверка капельной системы после зимы','Мониторинг разворачивания листьев для уточнения фенофазы'],
      alert:'🌡️ Следить за заморозками — молодая ткань менее устойчива, чем спящая почка' },
    { phase:'Зелёный конус', bbch:'BBCH 10', period:'Конец марта', kc:0.45, film:'Открытый сад', irrigation:'10–12 мм/неделю', nutrition:'Продолжение почвенной N-программы по норме анализа',
      protection:['Пик риска клястероспориоза (dc3) и монилиоза (dc1) при влажной погоде — системный фунгицид (Хорус) по прогнозу осадков','Пилильщики (sc_saw) — порог GDD 100, осмотр листьев с июня, скелетирование = поздний сигнал','Вишнёвая тля (sc_aph, dc7) — осмотр побегов при T>15°C и активном росте, скручивание листьев = уже поздно для профилактики'],
      tasks:['Расставить/проверить феромонные ловушки листовёрток','Проверить смыв осадками — при >15–20мм повторить обработку'],
      alert:'☔ Затяжная влажная погода = максимальный риск сильной эпифитотии коккомикоза и монилиоза на сезон' },
    { phase:'Бутонизация', bbch:'BBCH 51–55', period:'Начало апреля', kc:0.55, film:'Открытый сад', irrigation:'12–15 мм/неделю', nutrition:'Ca + B: борная кислота 0.3% + хелат Ca — закладка качества плода (по аналогии с черешней, Neilsen)',
      protection:['Последняя обработка от монилиоза системным фунгицидом ПЕРЕД цветением','Контактный инсектицид против долгоносика-цветоеда — строго ДО раскрытия цветков','Листовёртки (sc_tort) — порог GDD 220, обработка при массовом отрождении гусениц'],
      tasks:['Развезти ульи к саду (самоопыляемые сорта — Молодёжная/Любская — тоже выигрывают от опыления, перекрёстные — Владимирская — критично)','Проверить сроки последней обработки — выдержать срок ожидания для пчёл'],
      alert:'🐝 Прекратить инсектициды широкого спектра — пчёлы приступают к лёту' },
    { phase:'Начало цветения', bbch:'BBCH 61–65', period:'Апрель', kc:0.65, film:'Открытый сад', irrigation:'При заморозках — дождевание для защиты цветков, иначе не поливать', nutrition:'N ЗАПРЕЩЁН в цветение — риск избыточного вегетативного роста в ущерб завязи',
      protection:['🚫 ИНСЕКТИЦИДЫ ЗАПРЕЩЕНЫ — защита пчёл','Монилиальный ожог (dc1) — КЛЮЧЕВАЯ угроза именно в цветение: T 12–24°C + влажность = условия заражения через цветок','При дожде во время цветения — только безопасные для пчёл фунгициды (Свитч, Тельдор)'],
      tasks:['Фиксировать дату начала цветения по сортам — для калибровки GDD','Следить за лётом пчёл — не менее 5 пчёл/дерево при осмотре'],
      alert:'🔥 Дождь/влага в открытые цветки при тепле 12-24°C = риск монилиального ожога, реагировать быстро' },
    { phase:'Полное цветение', bbch:'BBCH 65–67', period:'Апрель', kc:0.75, film:'Открытый сад', irrigation:'При заморозках — дождевание, иначе не поливать', nutrition:'N по-прежнему запрещён. Аминокислотный стресс-протектор (по аналогии с черешней) при заморозках/суховее',
      protection:['🚫 ИНСЕКТИЦИДЫ ЗАПРЕЩЕНЫ — пик лёта пчёл','Монилиоз — риск максимален, мониторинг ежедневно по погоде'],
      tasks:['Пик учёта пчелоопыления','Наблюдать за суховеем — при RH<40% рыльце пестика пересыхает, риск бесплодия (по аналогии с черешней)'],
      alert:'🐝 Суховей RH<40% в разгар цветения — главный риск бесплодия сезона' },
    { phase:'Опадение лепестков', bbch:'BBCH 67–69', period:'Конец апреля', kc:0.8, film:'Открытый сад', irrigation:'15–20 мм/неделю', nutrition:'Ca(NO₃)₂ через капельницу или некорневая CaCl₂ 0.3% каждые 7-10 дней — старт Ca-программы',
      protection:['⚠️ Мучнистая роса (dc4) — MSU Extension: САМОЕ важное окно обработки за весь сезон — первая покровная сразу после опадения лепестков ("first cover timing")','Коккомикоз (dc2) — начало основной защитной программы, работает до октября'],
      tasks:['Начать мониторинг завязываемости по сортам','Продолжить контроль ловушек листовёрток и пилильщиков'],
      alert:'🍃 Пропуск первой покровной обработки после лепестков = потеря контроля над мучнистой росой на весь сезон (MSU)' },
    { phase:'Завязь 4–8 мм', bbch:'BBCH 71–72', period:'Начало – середина мая', kc:0.85, film:'Открытый сад', irrigation:'15–20 мм/неделю', nutrition:'Ca хелат каждые 7-10 дней — продолжение программы. N по остаточной потребности почвы, не форсировать',
      protection:['Коккомикоз (dc2) и клястероспориоз (dc3) — фунгицид по влажной погоде, критическая фаза для обоих','Вишнёвая тля (dc7) — при обнаружении колоний','Плодожорка вишнёвая (sc_moth) — порог GDD 300, феромонные ловушки с мая, 2 генерации/сезон'],
      tasks:['Оценить нагрузку урожаем по сортам','Мониторинг ловушек плодожорки'],
      alert:'🐛 Коккомикоз в эту фазу определяет запас листа на весь сезон — не пропускать обработки по прогнозу дождя' },
    { phase:'Рост плода', bbch:'BBCH 73–79', period:'Конец мая – июнь', kc:1.0, film:'Открытый сад', irrigation:'20–25 мм/неделю в жару, пульсирующий полив на лёгких почвах', nutrition:'K + Ca: нитрат калия 8-12 кг/га + хелат Ca. N по остаточной потребности',
      protection:['Коккомикоз — продолжение защиты, ротация по FRAC против резистентности','Паутинный клещ (sc_mite) — порог GDD 850, вспышка при T>28°C + RH<45%, осмотр нижней стороны листьев','Растрескивание плодов при резких перепадах влажности — избегать неравномерного полива'],
      tasks:['Установить сети от птиц','Ротация препаратов по FRAC группам — не более 2 обработок подряд одним МОА'],
      alert:'💧 Жара >30°C ускоряет транспирацию — на лёгких почвах дефицит проявляется быстро' },
    { phase:'Окрашивание плода', bbch:'BBCH 81–85', period:'Июнь', kc:0.95, film:'Открытый сад', irrigation:'15–20 мм/неделю, избыток воды снижает сахаристость и лёжкость', nutrition:'⛔ Стоп N. Только K (сульфат калия) — накопление сахара. Ca-обработки — последние',
      protection:['Вишнёвая муха (sc_fly) — порог GDD 850, жёлтые ловушки с начала июня, обработка при 5+ мух/ловушку, КРИТИЧНО в диапазоне GDD 1050-1450','Drosophila suzukii (sc_swd) — порог GDD 1050, ловушки с дрожжевой приманкой, красный риск при GDD>1050 + размягчение плода (модель валидирована MSU)'],
      tasks:['Мониторинг ловушек вишнёвой мухи и SWD ежедневно по мере приближения к порогу','Подготовить холодильные камеры/тару'],
      alert:'🪰 SWD откладывает яйца в МЯГКИЙ плод — риск резко растёт с началом размягчения, не дожидаться явных повреждений' },
    { phase:'Созревание', bbch:'BBCH 85–89', period:'Конец июня – июль', kc:0.85, film:'Открытый сад', irrigation:'15–20 мм/неделю, осторожно — избыток воды снижает Brix', nutrition:'Не применять — карантинный период ближе к сбору',
      protection:['Только препараты с коротким сроком ожидания (PHI ≤ 7 дней) при острой необходимости','Защитные сети от птиц'],
      tasks:['Тест на Brix по срокам сорта','Планирование очерёдности сбора: Шпанка (ранний) → Молодёжная/Владимирская (средний) → Тургеневка/Любская (поздний)','Сбор утром — плоды холоднее, меньше повреждений'],
      alert:'🍒 SWD и вишнёвая муха продолжают активность до конца сбора — не прекращать мониторинг ловушек' },
    { phase:'После сбора', bbch:'BBCH 91–93', period:'Июль – август', kc:0.6, film:'Открытый сад', irrigation:'Снижать постепенно к концу августа',
      nutrition:'P + K (суперфосфат + сульфат калия) — закладка плодовых почек на следующий год. ⚠️ MSU Extension: осенняя некорневая N-подкормка ранней осенью улучшает зимостойкость И увеличивает площадь листа шпорцевых веточек (→ крупнее плод в следующем сезоне) — см. фазу "Подготовка к листопаду" для деталей.',
      protection:['⚠️ MSU Extension: коккомикоз (dc2) — угроза №1 для вишни в регионе, защита листа ОБЯЗАТЕЛЬНА до октября — ранняя дефолиация от коккомикоза снижает зимостойкость и урожай СЛЕДУЮЩЕГО года, не только текущего','Хорус или аналог — коккомикоз, листья продолжают работать до осени'],
      tasks:['Летняя обрезка сразу после уборки','Почвенный и листовой анализ — план питания на следующий год','Ревизия капельного полива'],
      alert:'🍂 Не бросать сад после сбора! Защита листа до листопада = урожай следующего года (MSU/локальный опыт)' },
    { phase:'Подготовка к листопаду', bbch:'BBCH 93–97', period:'Сентябрь – октябрь', kc:0.5, film:'Открытый сад', irrigation:'Снижать до минимума, прекратить к концу октября',
      nutrition:'⚠️ MSU Extension (Montmorency): осенняя некорневая N — мочевина низкобиуретовая (формулированная именно для листовых обработок), суммарно 40 фунтов/акр (≈45 кг/га) д.в. мочевины, СПЛИТ на 2 обработки — начало сентября + повтор через 1-2 недели (либо начало октября как альтернативное окно). Улучшает зимостойкость И увеличивает площадь листа шпорцевых веточек → крупнее плод в следующем сезоне. ⛔ Работает ТОЛЬКО при сохранном облиствении — если дерево уже потеряло значительную часть листвы (например от коккомикоза), эффекта не будет: нечему поглощать и транспортировать вещество в запасающие ткани.',
      protection:['Побелка штамбов в октябре-ноябре','Медьсодержащий препарат перед листопадом — снижает инфекционный фон монилиоза и клястероспориоза','Санитарная вырезка язв бактериального рака'],
      tasks:['Обрезка после листопада','Ревизия системы капельного полива и антизаморозки к зиме','Подготовка сада к зиме — мульчирование приствольных полос'],
      alert:'🍂 Осеннюю N не вносить при сильно осыпавшемся листе — растение не успеет усвоить и транспортировать (MSU)' },
  ],
};
...
const VARIETY_REFERENCE = {
  ...
  'гренни смит': { cropId:'crop_apple', name:'Гренни Смит (Granny Smith)', origin:'Австралия', year:1868, ripening:'Поздний', pollType:'cross', pollinators:'Голден Делишес, Ред Делишес', fruitWeight:190, fruitColor:'Зелёный', fruitFirmness:'Очень плотная', fruitTaste:'Кислый, освежающий', brix:11, crackResistance:'4', vigor:'Сильнорослый', bearingYear:4, yield:35, spacing:'3×1', rootstockRec:'М9', resMonilia:'3', resScab:'3', frost:'3', note:'Самый поздний сорт, очень теплолюбив. Высокий риск горькой ямчатости и загара при хранении — обязательна Ca-программа (см. технокарту).' },
