...
const TECHMAP = {
  ...
  crop_apple: [
    ...
    { phase:'Завязь', bbch:'BBCH 71–75 (Petal Fall)', period:'Конец апреля – май', kc:0.75, film:'Открытый сад', irrigation:'15–20 мм/неделю', nutrition:'Ca(NO₃)₂ через капельницу или некорневая CaCl₂ 0.3% каждые 7–10 дней — старт основной программы против bitter pit (≈4.5–16 кг Ca/га за сезон, Rutgers 10.3; ~10 кг Ca/га/год — ориентир BC Tree Fruit Guide, укладывается в диапазон). ⚠️ CaCl₂ НЕ смешивать в баке с каптаном, карбарилом (Sevin XLR — см. прореживание ниже), тиофанат-метилом (Топсин), препаратами Mg или Zn — несовместимы (BC Tree Fruit Guide); не обрабатывать при T>27°C — риск ожога листа. Не злоупотреблять K в этот период — избыток K подавляет усвоение Ca и Mg',
