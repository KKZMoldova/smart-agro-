...
const TECHMAP = {
  ...
  crop_apple: [
    ...
    { phase:'После сбора', bbch:'BBCH 91–97', period:'Сентябрь – октябрь', kc:0.6, film:'Открытый сад', irrigation:'Снижать постепенно до конца октября, затем прекратить', nutrition:'P + K (суперфосфат + сульфат калия) — закладка плодовых почек следующего года. Осенний листовой анализ — план питания на будущий сезон',
      protection:['Ca-ванна перед закладкой на хранение — хлорид кальция (пищевой) в дип-растворе снижает горькую ямчатость и улучшает лёжкость (Rutgers 10.3, "Dip before Storage")','Медьсодержащий препарат перед листопадом — снижает инфекционный фон парши и бактериального ожога на будущий год'],
      tasks:['Обрезка после листопада, вырезка язв бактериального ожога — санитария на будущий сезон','Почвенный и листовой анализ — основа плана питания','Ревизия системы капельного полива и антизаморозки к зиме'],
      alert:'🍂 Санитарная обрезка сейчас снижает и паршу, и бактериальный ожог в следующем сезоне' },
  ],
};
