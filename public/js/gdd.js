...
const TECHMAP = {
  ...
  crop_sour_cherry: [
    ...
    { phase:'Созревание', bbch:'BBCH 85–89', period:'Конец июня – июль', kc:0.85, film:'Открытый сад', irrigation:'15–20 мм/неделю, осторожно — избыток воды снижает Brix', nutrition:'Не применять — карантинный период ближе к сбору',
      ...
      tasks:['Тест на Brix по срокам сорта','Планирование очерёдности сбора: Молодёжная/Владимирская (средний срок) → Тургеневка/Любская (поздний срок)','Сбор утром — плоды холоднее, меньше повреждений'],
