...
const TECHMAP = {
  ...
  crop_apple: [
    ...
    { phase:'Набухание почек', bbch:'BBCH 01–03 (Delayed Dormant – ½" Green)', period:'Начало марта', kc:0.15, film:'Открытый сад', irrigation:'Минимальный — 5–8 мм/неделю', nutrition:'Некорневая мочевина 2–3% при слабом N по листовому анализу прошлого года',
      ...
      tasks:['Проверить работу феромонных ловушек и метеостанции','Установить ловушки на яблонную плодожорку — старт отсчёта DD (база 10°C/50°F) от первого устойчивого улова','Первая калибровка датчиков влажности почвы'],
      alert:'❄️ Почки уязвимы к заморозкам от -3…-4°C на этой стадии' },
    { phase:'Зелёный конус', bbch:'BBCH 07–09 (Green Tip)', period:'Середина марта', kc:0.25, film:'Открытый сад', irrigation:'8–10 мм/неделю', nutrition:'N-старт: аммиачная селитра или КАС по норме почвенного анализа (общий вынос сезона N 170 кг/га на 60 т/га — Sela Прил.II)',
    ...
    { phase:'Розовый бутон', bbch:'BBCH 55–57 (Pink)', period:'Начало апреля', kc:0.45, film:'Открытый сад', irrigation:'12–15 мм/неделю', nutrition:'B (Solubor) 0.3–0.5 кг/100 л при полном цветении и через неделю — снижает пробковую пятнистость, участвует в транспорте Ca (Rutgers 10.3)',
    ...
    { phase:'Завязь', bbch:'BBCH 71–75 (Petal Fall)', period:'Конец апреля – май', kc:0.75, film:'Открытый сад', irrigation:'15–20 мм/неделю', nutrition:'Ca(NO₃)₂ через капельницу или некорневая CaCl₂ 0.3% каждые 7–10 дней — старт основной программы против bitter pit (4–14 фунтов Ca/акр за сезон, Rutgers 10.3)',
    ...
    { phase:'Созревание', bbch:'BBCH 81–89', period:'Август – сентябрь (по сорту)', kc:0.9, film:'Открытый сад', irrigation:'15–20 мм/неделю, избыток воды снижает Brix и лёжкость', nutrition:'⛔ Стоп N за 4–6 недель до сбора. Ca-обработки продолжать до последней недели — главная защита от горькой ямчатости в хранении',
    ...
    { phase:'После сбора', bbch:'BBCH 91–97', period:'Сентябрь – октябрь', kc:0.6, film:'Открытый сад', irrigation:'Снижать постепенно до конца октября, затем прекратить',
      nutrition:'Осенняя некорневая N: мочевина 8–10 фунтов д.в./100 галлонов/акр (≈0.9–1.1 кг д.в./100л), после сбора но ДО начала естественного листопада (пока листья ещё зелёные/желтеют), при 20–30°C, влажно, без сильного ветра — усвоение 30–80%. Вносить только если N по листу <1.7% или было тяжёлое плодоношение (при 1.7–2.5% — не нужно). Осенний B: 1–1.6 фунта д.в./100 галлонов (борат натрия/борная к-та) — эффективнее весеннего для B в цветках будущего года. Осенний Zn (яблоня): 8–10 фунтов д.в./акр (сульфат цинка) — при дефиците по листу <25 ppm; разово осенью цинк в листьях в целом не поднимает, только в почках/цветках — нужны регулярные обработки в течение сезона, не только осенью. Смешивание микроэлементов с мочевиной улучшает усвоение (WSU Tree Fruit, Sallato).',
      protection:['Ca-ванна перед закладкой на хранение — хлорид кальция (пищевой) в дип-растворе снижает горькую ямчатость и улучшает лёжкость (Rutgers 10.3, "Dip before Storage")','Мочевина 5% — ускоряет листопад и разложение листвы, снижает запас инфекции парши (Venturia inaequalis) на будущий год (WSU Tree Fruit)','Мочевина 2% + сульфат цинка 2% — ускоряет листопад и повышает морозостойкость дерева (WSU Tree Fruit)','Медьсодержащий препарат перед листопадом — дополнительно снижает инфекционный фон парши и бактериального ожога'],
      ...
      alert:'🌡️ Осеннюю некорневую N/B/Zn не вносить при <20°C или >29°C (68–85°F) — резко падает усвоение (WSU Tree Fruit)' },
  ],
};
