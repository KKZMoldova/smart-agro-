...
let S = {
  ...
  diseaseCatalog:[
    ...
    {id:'dc20',name:'Бактериальный ожог (Fire Blight)',latin:'Erwinia amylovora',type:'bacterial',danger:5,cropIds:['crop_apple'],
     ...
     prevention:'Вырезка и сжигание язв зимой (санитария — ключевой контроль). Медьсодержащий по спящим почкам. Риск максимален при T>15.5°C + дождь/влага в открытые цветки — реагировать в течение 24ч.'},
