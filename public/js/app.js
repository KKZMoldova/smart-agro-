...
let S = {
  ...
  crops: [
    ...
    },
    {
      ...
      diseases:['dc8','dc9','dc10','dc20','dc21','dc22','dc23','dc24','dc25'], // refs to diseaseCatalog — парша, мучнистая роса, плодожорка, бактериальный ожог, плодовая муха, казарка, пилильщик, минирующая моль, сажистый налёт/мухосед (полная модель риска)
      pests:[
