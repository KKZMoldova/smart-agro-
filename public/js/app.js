...
let S = {
  ...
  crops: [
    ...
    },
    {
      ...
      diseases:['dc8','dc9','dc10','dc20','dc21','dc22','dc23','dc24','dc25','dc26','dc27'], // refs to diseaseCatalog — парша, мучнистая роса, плодожорка, бактериальный ожог, плодовая муха, казарка, пилильщик, минирующая моль, сажистый налёт/мухосед, шерстистая тля, альтернариоз (полная модель риска)
      pests:[
  ...
  diseaseCatalog:[
    ...
    {id:'dc26',name:'Шерстистая тля (Woolly Apple Aphid)',latin:'Eriosoma lanigerum',type:'insect',danger:3,cropIds:['crop_apple'],
     ...
     prevention:'Порог обработки: 10 колоний на 100 осмотренных органов (ERSA FVG). Мониторинг штамба и корневой шейки, не только кроны.'},
    {id:'dc27',name:'Альтернариоз (Alternaria leaf blotch/fruit rot)',latin:'Alternaria alternata',type:'fungal',danger:2,cropIds:['crop_apple'],
     ...
     criticalPhases:['Завязь','Рост плода'],phase:'all',
     symptoms:'Некротические пятна на листьях, иногда с жёлтым ореолом; на восприимчивых сортах (Gala, Golden Delicious, Pink Lady) может поражать и плоды в хранении.',
     products:'Флуазинам, SDHI (флуксапироксад/пентиопирад — попутный эффект при обработке от парши), дитианон',
     prevention:'Риск существует уже с завязи на восприимчивых сортах (ERSA FVG: Gala — одна из чувствительных). Отдельная обработка обычно не нужна — препараты от парши (флуазинам/SDHI/дитианон) закрывают и эту угрозу.'},
  ],
